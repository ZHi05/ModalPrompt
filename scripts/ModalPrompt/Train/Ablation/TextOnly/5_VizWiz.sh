...
TB_LOG_DIR=${TB_LOG_DIR:-runs/ModalPrompt_TextOnly/VizWiz}
SEED=${SEED:-42}
...
deepspeed ${DS_LAUNCH_ARGS} llava/train/train_mem.py \
    ...
    --previous_task_model_path checkpoints/ModalPrompt_TextOnly/GQA/llava-1.5-7b \
    ...
    --bf16 True \
    --output_dir checkpoints/ModalPrompt_TextOnly/VizWiz/llava-1.5-7b \
    --num_train_epochs 4 \
