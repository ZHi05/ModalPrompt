...
TB_LOG_DIR=${TB_LOG_DIR:-runs/ModalPrompt_TextOnly/OCRVQA}
SEED=${SEED:-42}
...
deepspeed ${DS_LAUNCH_ARGS} llava/train/train_mem.py \
    ...
    --previous_task_model_path checkpoints/ModalPrompt_TextOnly/VQAv2/llava-1.5-7b \
    ...
    --bf16 True \
    --output_dir checkpoints/ModalPrompt_TextOnly/OCRVQA/llava-1.5-7b \
    --num_train_epochs 4 \
